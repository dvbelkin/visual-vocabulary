...
export const charts: readonly ChartDefinition[] = [
    ...
    },
    {
        ...
        description: {
            ru: "Цвет территорий показывает относительный показатель, сопоставимый между районами.",
            en: "Area colour encodes a relative measure that can be compared across districts.",
        },
        useWhen: {
            ru: "Нужно показать географический рисунок долей, коэффициентов или интенсивности.",
            en: "You need to show the geographic pattern of rates, shares, or intensity.",
        },
        avoidWhen: {
            ru: "Данные являются абсолютными итогами: площадь территорий исказит впечатление.",
            en: "Values are absolute totals, because area size will distort the impression.",
        },
        unit: { ru: "% поездок на велосипеде", en: "% of trips by bicycle" },
        data: [
            { label: { ru: "Северный", en: "North" }, value: 18, values: [1, 0] },
            { label: { ru: "Северо-западный", en: "Northwest" }, value: 12, values: [0, 0] },
            { label: { ru: "Северо-восточный", en: "Northeast" }, value: 22, values: [2, 0] },
            { label: { ru: "Западный", en: "West" }, value: 9, values: [0, 1] },
            { label: { ru: "Центральный", en: "Central" }, value: 31, values: [1, 1] },
            { label: { ru: "Восточный", en: "East" }, value: 25, values: [2, 1] },
            { label: { ru: "Юго-западный", en: "Southwest" }, value: 7, values: [0, 2] },
            { label: { ru: "Южный", en: "South" }, value: 16, values: [1, 2] },
            { label: { ru: "Юго-восточный", en: "Southeast" }, value: 20, values: [2, 2] },
        ],
    },
    {
        id: "proportional-symbol-map",
        category: "spatial",
        kind: "proportional-map",
        title: { ru: "Карта пропорциональных символов", en: "Proportional symbol map" },
        description: {
            ru: "Площадь круга кодирует абсолютную величину в географической точке.",
            en: "Circle area encodes an absolute quantity at a geographic location.",
        },
        useWhen: {
            ru: "Нужно сравнить абсолютные объёмы в городах или точках.",
            en: "You need to compare absolute totals across cities or locations.",
        },
        avoidWhen: {
            ru: "Точки сильно перекрываются или важны небольшие различия.",
            en: "Locations overlap heavily or small differences must be read precisely.",
        },
        unit: { ru: "тыс. пассажиров", en: "thousand passengers" },
        data: [
            { label: { ru: "Речной", en: "Riverside" }, value: 480, value2: 22, value3: 68 },
            { label: { ru: "Центр", en: "Central" }, value: 820, value2: 49, value3: 48 },
            { label: { ru: "Университет", en: "University" }, value: 350, value2: 66, value3: 27 },
            { label: { ru: "Вокзал", en: "Station" }, value: 610, value2: 78, value3: 61 },
            { label: { ru: "Парк", en: "Park" }, value: 190, value2: 34, value3: 24 },
        ],
    },
    {
        id: "map-flows",
        ...
        description: {
            ru: "Линии связывают места отправления и назначения, а толщина показывает объём.",
            en: "Lines connect origins and destinations, with width indicating volume.",
        },
        useWhen: {
            ru: "Нужно показать направление и масштаб перемещений между местами.",
            en: "You need to show the direction and scale of movement between places.",
        },
        avoidWhen: {
            ru: "Маршрутов так много, что линии перекрывают географический рисунок.",
            en: "There are so many routes that lines obscure the geographic pattern.",
        },
        unit: { ru: "тыс. поездок", en: "thousand trips" },
        data: [
            {
                label: { ru: "Запад|Центр", en: "West|Central" },
                value: 38,
                values: [12, 48, 50, 48],
            },
            {
                label: { ru: "Север|Центр", en: "North|Central" },
                value: 27,
                values: [46, 82, 50, 48],
            },
            {
                label: { ru: "Восток|Центр", en: "East|Central" },
                value: 34,
                values: [88, 58, 50, 48],
            },
            { label: { ru: "Юг|Центр", en: "South|Central" }, value: 21, values: [58, 12, 50, 48] },
        ],
    },
    {
        id: "contour-map",
        ...
        description: {
            ru: "Изолинии соединяют места с одинаковым уровнем непрерывного показателя.",
            en: "Isolines connect locations with the same level of a continuous measure.",
        },
        useWhen: {
            ru: "Показатель непрерывен в пространстве, например высота или температура.",
            en: "The measure varies continuously in space, such as elevation or temperature.",
        },
        avoidWhen: {
            ru: "Измерений мало или границы административных районов важнее поверхности.",
            en: "Measurements are sparse or administrative boundaries matter more than the surface.",
        },
        unit: { ru: "метров над уровнем моря", en: "metres above sea level" },
        data: [
            {
                label: { ru: "100 м", en: "100 m" },
                value: 100,
                values: [10, 32, 28, 20, 52, 18, 78, 28, 92, 44],
            },
            {
                label: { ru: "200 м", en: "200 m" },
                value: 200,
                values: [18, 48, 34, 34, 54, 31, 72, 40, 84, 57],
            },
            {
                label: { ru: "300 м", en: "300 m" },
                value: 300,
                values: [29, 61, 43, 48, 57, 46, 68, 53, 75, 66],
            },
        ],
    },
    {
        id: "equalized-cartogram",
        category: "spatial",
        kind: "equalized-cartogram",
        title: { ru: "Эквализированная картограмма", en: "Equalised cartogram" },
        description: {
            ru: "Одинаковые ячейки дают каждой территории равный визуальный вес.",
            en: "Equal-sized cells give every territory the same visual weight.",
        },
        useWhen: {
            ru: "Территории равноправны, а их физическая площадь мешает сравнению.",
            en: "Territories are peers and their physical area hinders comparison.",
        },
        avoidWhen: {
            ru: "Читателю нужна узнаваемая форма и точное положение территорий.",
            en: "Readers need recognisable shapes and precise geographic positions.",
        },
        unit: { ru: "% озеленённой площади", en: "% green space" },
        data: [
            { label: { ru: "А", en: "A" }, value: 24, values: [0, 1] },
            { label: { ru: "Б", en: "B" }, value: 37, values: [1, 0] },
            { label: { ru: "В", en: "C" }, value: 18, values: [1, 1] },
            { label: { ru: "Г", en: "D" }, value: 42, values: [2, 1] },
            { label: { ru: "Д", en: "E" }, value: 29, values: [1, 2] },
            { label: { ru: "Е", en: "F" }, value: 33, values: [2, 2] },
        ],
    },
    {
        id: "scaled-cartogram",
        category: "spatial",
        kind: "scaled-cartogram",
        title: { ru: "Масштабированная картограмма", en: "Scaled cartogram" },
        description: {
            ru: "Размер территории изменяется пропорционально выбранному показателю.",
            en: "Territory size is distorted in proportion to the selected measure.",
        },
        useWhen: {
            ru: "Нужно подчеркнуть величину показателя, сохранив приблизительное соседство.",
            en: "You need to emphasise magnitude while retaining approximate neighbourhoods.",
        },
        avoidWhen: {
            ru: "Узнаваемая география важнее сравнения величин.",
            en: "Recognisable geography matters more than comparing magnitudes.",
        },
        unit: { ru: "тыс. жителей", en: "thousand residents" },
        data: [
            { label: { ru: "А", en: "A" }, value: 120, values: [18, 55] },
            { label: { ru: "Б", en: "B" }, value: 360, values: [42, 70] },
            { label: { ru: "В", en: "C" }, value: 240, values: [68, 62] },
            { label: { ru: "Г", en: "D" }, value: 520, values: [52, 32] },
            { label: { ru: "Д", en: "E" }, value: 180, values: [79, 27] },
        ],
    },
    {
        id: "dot-density-map",
        ...
        description: {
            ru: "Каждая точка обозначает отдельный объект и раскрывает локальные скопления.",
            en: "Each point represents an object, revealing local clusters.",
        },
        useWhen: {
            ru: "Важны фактические места событий и форма их пространственного распределения.",
            en: "Actual event locations and the shape of their spatial distribution matter.",
        },
        avoidWhen: {
            ru: "Координаты чувствительны или точек слишком много для читаемого рисунка.",
            en: "Coordinates are sensitive or there are too many points for a readable pattern.",
        },
        unit: { ru: "пунктов велопроката", en: "bike-share stations" },
        data: [
            { label: { ru: "1", en: "1" }, value: 1, value2: 22, value3: 64 },
            { label: { ru: "2", en: "2" }, value: 1, value2: 27, value3: 58 },
            { label: { ru: "3", en: "3" }, value: 1, value2: 31, value3: 68 },
            { label: { ru: "4", en: "4" }, value: 1, value2: 45, value3: 47 },
            { label: { ru: "5", en: "5" }, value: 1, value2: 51, value3: 52 },
            { label: { ru: "6", en: "6" }, value: 1, value2: 55, value3: 43 },
            { label: { ru: "7", en: "7" }, value: 1, value2: 62, value3: 49 },
            { label: { ru: "8", en: "8" }, value: 1, value2: 73, value3: 29 },
            { label: { ru: "9", en: "9" }, value: 1, value2: 77, value3: 35 },
            { label: { ru: "10", en: "10" }, value: 1, value2: 82, value3: 25 },
        ],
    },
    {
        id: "spatial-heatmap",
        ...
        description: {
            ru: "Регулярная сетка показывает интенсивность явления независимо от границ районов.",
            en: "A regular grid shows phenomenon intensity independently of district boundaries.",
        },
        useWhen: {
            ru: "Нужно увидеть очаги и плавные пространственные градиенты.",
            en: "You need to reveal hotspots and gradual spatial gradients.",
        },
        avoidWhen: {
            ru: "Размер ячейки скрывает важные локальные различия или требуется точная адресность.",
            en: "Cell size hides important local variation or exact locations are required.",
        },
        unit: { ru: "наблюдений на ячейку", en: "observations per cell" },
        data: [
            { label: { ru: "A1", en: "A1" }, value: 4, values: [0, 0] },
            { label: { ru: "A2", en: "A2" }, value: 9, values: [1, 0] },
            { label: { ru: "A3", en: "A3" }, value: 13, values: [2, 0] },
            { label: { ru: "B1", en: "B1" }, value: 7, values: [0, 1] },
            { label: { ru: "B2", en: "B2" }, value: 22, values: [1, 1] },
            { label: { ru: "B3", en: "B3" }, value: 17, values: [2, 1] },
            { label: { ru: "C1", en: "C1" }, value: 3, values: [0, 2] },
            { label: { ru: "C2", en: "C2" }, value: 11, values: [1, 2] },
            { label: { ru: "C3", en: "C3" }, value: 8, values: [2, 2] },
        ],
    },
];
