...
export const charts: readonly ChartDefinition[] = [
    ...
    },
    {
        ...
        description: {
            ru: "Ширина блока пропорциональна числу участников курса, высота сегмента — доле формата внутри курса, а площадь — числу участников этого формата.",
            en: "Block width is proportional to cohort size, segment height shows the format share within that cohort, and area represents the participant count for that format.",
        },
        useWhen: {
            ru: "Нужно одновременно сравнить размеры групп и условный состав каждой группы по двум категориям.",
            en: "You need to compare group sizes and each group's conditional composition across two categories.",
        },
        avoidWhen: {
            ru: "Нужно точно сравнить значения: переменная ширина и площадь сложнее обычных столбцов.",
            en: "Exact comparison matters; varying width and area are harder to read than ordinary bars.",
        },
        unit: { ru: "участников", en: "participants" },
        valueLabels: {
            primary: { ru: "Всего участников", en: "Total participants" },
            secondary: { ru: "Онлайн", en: "Online" },
            tertiary: { ru: "Очно", en: "In person" },
        },
        data: [
            { label: { ru: "Первый курс", en: "Year one" }, value: 420, value2: 260, value3: 160 },
            { label: { ru: "Второй курс", en: "Year two" }, value: 310, value2: 167, value3: 143 },
            { label: { ru: "Третий курс", en: "Year three" }, value: 220, value2: 95, value3: 125 },
            {
                label: { ru: "Четвёртый курс", en: "Year four" },
                value: 130,
                value2: 46,
                value3: 84,
            },
    ...
    },
    {
        ...
        category: "spatial",
        kind: "flow-map",
        title: { ru: "Дуги миграционных потоков", en: "Migration flow arcs" },
        description: {
            ru: "Дуги связывают округ Лос-Анджелес с округами назначения: толщина кодирует число переехавших, цвет — направление чистого потока.",
            en: "Arcs connect Los Angeles County to destination counties: width encodes migrant count and colour shows net-flow direction.",
        },
        useWhen: {
        ...
        unit: { ru: "человек", en: "people" },
        dataStatus: {
            ru: "Реальные данные · оценки миграции 2009–2013",
            en: "Real data · 2009–2013 migration estimates",
        },
        source: {
            label: { ru: "Бюро переписи США через deck.gl", en: "US Census Bureau via deck.gl" },
            url: "https://deck.gl/examples/arc-layer",
        },
        data: [
            {
                label: { ru: "Лос-Анджелес → Сан-Бернардино", en: "Los Angeles → San Bernardino" },
                value: 18204,
            },
            {
                label: { ru: "Лос-Анджелес → Риверсайд", en: "Los Angeles → Riverside" },
                value: 12111,
            },
            {
                label: { ru: "Лос-Анджелес → Ориндж", en: "Los Angeles → Orange" },
                value: 12975,
            },
        ],
    },
    {
        ...
        category: "spatial",
        kind: "contour-map",
        title: { ru: "Гексагональная агрегация", en: "Hexagonal aggregation" },
        description: {
            ru: "Дорожные происшествия объединены в одинаковые шестиугольные ячейки; цвет и высота показывают число событий внутри каждой ячейки.",
            en: "Road accidents are grouped into equal hexagonal cells; colour and height show the number of events in each cell.",
        },
        useWhen: {
            ru: "Нужно сравнить локальную концентрацию множества точек без наложения отдельных маркеров.",
            en: "You need to compare local concentration across many points without overlapping individual markers.",
        },
        avoidWhen: {
            ru: "Размер ячейки влияет на вывод; не используйте карту для чтения точных адресов отдельных событий.",
            en: "Cell size affects the result; do not use this map to read exact locations of individual events.",
        },
        unit: { ru: "происшествия в ячейке", en: "accidents per cell" },
        dataStatus: {
            ru: "Реальные данные · дорожные происшествия Великобритании",
            en: "Real data · Great Britain road accidents",
        },
        source: {
            label: { ru: "DATA.GOV.UK через deck.gl", en: "DATA.GOV.UK via deck.gl" },
            url: "https://deck.gl/examples/hexagon-layer",
        },
        valueLabels: {
            primary: { ru: "Происшествия", en: "Accidents" },
            secondary: { ru: "Долгота", en: "Longitude" },
            tertiary: { ru: "Широта", en: "Latitude" },
        },
        data: [
            {
                label: { ru: "Район Лондона", en: "London area" },
                value: 5033,
                value2: -0.13,
                value3: 51.51,
            },
            {
                label: { ru: "Район Бирмингема", en: "Birmingham area" },
                value: 736,
                value2: -1.9,
                value3: 52.48,
            },
            {
                label: { ru: "Район Манчестера", en: "Manchester area" },
                value: 3079,
                value2: -2.24,
                value3: 53.48,
            },
    ...
    },
    {
        ...
        category: "spatial",
        kind: "tile-cartogram",
        title: { ru: "Движущиеся маршруты", en: "Animated trips" },
        description: {
            ru: "Светящиеся следы показывают движение жёлтых и зелёных такси по Манхэттену в течение выбранного получаса.",
            en: "Moving trails show yellow and green taxi trips across Manhattan during a selected half-hour.",
        },
        useWhen: {
            ru: "Важны путь, направление и одновременное изменение положения объектов во времени.",
            en: "Path, direction, and simultaneous movement of objects over time all matter.",
        },
        avoidWhen: {
            ru: "Для точного сравнения количества поездок по времени лучше использовать агрегированный временной ряд.",
            en: "Use an aggregated time series when exact comparison of trip counts over time is required.",
        },
        unit: { ru: "поездки такси", en: "taxi trips" },
        dataStatus: {
            ru: "Реальные данные · 16 июня 2016, 21:00–21:30",
            en: "Real data · 16 June 2016, 21:00–21:30",
        },
        source: {
            label: {
                ru: "NYC Taxi & Limousine Commission через deck.gl",
                en: "NYC Taxi & Limousine Commission via deck.gl",
            },
            url: "https://deck.gl/examples/trips-layer",
        },
        valueLabels: {
            primary: { ru: "Число маршрутов", en: "Trip count" },
        },
        data: [
            { label: { ru: "Все такси", en: "All taxis" }, value: 996 },
            { label: { ru: "Жёлтые такси", en: "Yellow taxis" }, value: 802 },
            { label: { ru: "Зелёные такси", en: "Green taxis" }, value: 194 },
        ],
    },
    {
